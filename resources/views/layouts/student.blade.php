...
<head>
    ...
    <style>
        ...
        .nav-link { @apply flex items-center gap-2 px-4 py-2 text-gray-600 rounded-xl transition-all duration-200 text-sm font-medium; }
        .nav-link:hover { @apply bg-indigo-50 text-indigo-600; }
        .nav-link.active { @apply bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-lg shadow-indigo-500/25; }
        .glass-card { @apply bg-white/80 backdrop-blur-xl border border-white/20 shadow-xl rounded-2xl; }
        .gradient-text { @apply bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent; }
    </style>
</head>
