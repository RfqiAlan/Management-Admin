<x-admin-layout title="Tambah Kategori" header="Tambah Kategori">
    <!-- Back Button -->
    ...
    <div class="max-w-2xl" data-aos="fade-up">
        <div class="glass-card rounded-2xl p-8">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-800">Kategori Baru</h2>
                    <p class="text-sm text-gray-500">Tambahkan kategori untuk klasifikasi keluhan</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                              ...
                              class="block w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition-all resize-none">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
